...
public class FileTools extends Constans {
    ...
    public static void readFileBookings()throws IOException {
        br = new BufferedReader(new java.io.FileReader(txtBookings));
        String sLine = null;
    ...
    public static void readFileUsers()throws IOException{
        br = new BufferedReader(new java.io.FileReader(txtUsers));
        String sLine = null;
    ...
    public static void wtiteFileBookings()throws IOException{
        ...
        for (Booking booking:lsBooking){
            i++;
            String outPutText= i +sep+ booking.getsUserName() +
                    sep+ booking.getiRoomNr() +sep+ booking.getsDate() +
                    sep+ booking.getsBookingName() +sep+ booking.getsTime() +
                    sep+ booking.getfDuration() +sep+ booking.getsNots();
            bw.write(outPutText);
            bw.write("\n");
        }
        bw.flush();
